...
export default class extends FAMILY {
    ...
    top_family = "剑门";
    can_battle = true;
    def_npcs = [["huashan/yuebuqun", "huashan/keting"],
...
["huashan/gaogenming", "huashan/zhenyue"]];
    boss_path = "huashan/yuebuqun";
    boss_guard = ["huashan/keting", "huashan/lianwu", "huashan/yunv"];
    guard_rooms = ['huashan/xiaowu', 'huashan/pingdi', 'huashan/siguoya',
    'huashan/luoyan'];
    npc_skills = [
    ["dodge", 800],
    ["parry", 800],
