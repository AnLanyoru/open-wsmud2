...
export default class extends FAMILY {
    ...
    gender = 2;
    can_battle = true;
    def_npcs = [["emei/jingxin", "emei/dadian"],
...
["pub/mpguanli#EMEI", "emei/zoulang2"]];
    boss_path = "emei/miejue";
    boss_guard = ["emei/qingxiu", "emei/zoulang3", "emei/zoulang2"];
    guard_rooms = ['emei/dadian', 'emei/huacang', 'emei/duguangtai',
    'emei/xiuxishi'];
    npc_skills = [["dodge", 100],
["parry", 100],
["force", 100],
["unarmed", 100],
["sword", 100],
