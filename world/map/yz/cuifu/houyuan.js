...
export default class extends ROOM {
    name = "后院";
    desc = "这里是财主后院，各种古玩琳琅满目，商周青铜、汉瓦当、唐三彩……，应有尽有，只要拥有一件，就够你吃一辈子了。崔员外正坐在琉璃榻上，慢幽幽地喝着参汤。东侧有一扇<cmd cmd='look men'>门(men)</cmd>。";
    exits = { "south": "yz/cuifu/dayuan", "west": "yz/cuifu/xixiang" };
