...
export default class MapRoom extends ROOM {
    ...
    constructor() {
        ...
        this.add_action('pushmen', null, this.pushmen);
    ...
    search(this: MapRoom, me: CHARACTER) {
        ...
        var odds: { obj: string | string[]; min?: number; max?: number; odds?: number }[] = [
            { obj: "st/xuanjing", min: 1, max: 10 },
            { obj: ["st/st_blu#0", "st/st_gre#0", "st/st_red#0", "st/st_yel#0"], min: 1, max: 3 },
            { obj: ["st/st_blu#1", "st/st_gre#1", "st/st_red#1", "st/st_yel#1"], odds: 3000 },
            { obj: ["book/book#blade", "book/book#sword", "book/book#dodge", "book/book#parry", "book/book#force"], odds: 5000 },
        ];
    ...
    pushmen(this: MapRoom, me: CHARACTER) {
        if (me.equipment && me.equipment[0] && me.equipment[0].is('eq/lv1/qianjinquan')) {
    ...
    lkfb(this: MapRoom, me: CHARACTER, par?: string) {
