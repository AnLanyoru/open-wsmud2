...
export default class extends COMMAND {
    ...
    if (!(WORLD.COMMANDS['events'] as any).check_command(this.biwu_state, me)) return;
    ...
    (me as any).die = challenge_end;
    (npc as any).die = challenge_end;
    room.on_heart_beat = this.on_heart_beat;
    (room as any).biwu_step = 0;
    me.auto_pfm = true;
    (me as any).check_pfms = this.check_pfms;
    (me as any).init_pfms = this.init_pfms;
